...
export const StatsPanel: React.FC<StatsPanelProps> = ({ stats }) => {
  ...
  return (
    // MODIFIED: Re-added group and hover:scale for the main div
    <div className="bg-white/20 dark:bg-gray-800/20 backdrop-blur-xl rounded-3xl shadow-xl hover:shadow-2xl border border-gray-300/30 dark:border-gray-700/30 overflow-hidden elevation-2 animate-fade-in group hover:scale-[1.01] transition-all duration-300 ease-in-out">
      <button
      ...
      {/* MODIFIED: Changed max-h transition for a more 'expanding' feel, added transform-gpu */}
