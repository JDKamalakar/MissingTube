          ...
          >
            ...
            <div className="relative p-3 sm:p-4 pb-2">
              <div className="relative bg-white/20 dark:bg-black/20 rounded-2xl overflow-hidden">
                ...
                <div className="flex items-center absolute bottom-2 right-2 gap-1 bg-white/20 text-white backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 elevation-3 px-3 py-3 sm:px-3 sm:py-3 mobile-text-xs sm:text-sm hover:scale-105 transition-transform duration-200"> {/* ADDED hover:scale-105 */}
                ...
                <div className="absolute top-2 left-2 flex items-center gap-3 bg-white/20 text-white backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 elevation-3 px-3 py-3 sm:px-3 sm:py-3 mobile-text-xs sm:text-xs hover:scale-105 transition-transform duration-200"> {/* ADDED hover:scale-105 */}
