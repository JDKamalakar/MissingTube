...
export const VideoDescriptionModal: React.FC<VideoDescriptionModalProps> = ({ video, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className="relative bg-white/30 dark:bg-black/40 backdrop-blur-heavy rounded-3xl shadow-2xl border border-white/30 dark:border-white/20 w-full max-w-2xl animate-modal-enter elevation-3 max-h-[85vh] flex flex-col"
        role="dialog"
        aria-modal="true"
      >
        ...
        <div className="p-8 flex-1 overflow-y-auto custom-scrollbar-hide">
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 p-4 bg-white/30 dark:bg-black/30 backdrop-blur-lg rounded-2xl border border-white/30 dark:border-white/20 shadow-sm transition-all duration-300 hover:scale-[1.08]">
              <img
                src={video.thumbnail}
                alt={video.title}
              ...
              <div className="flex-1 min-w-0">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-white/30 dark:bg-black/30 backdrop-blur-lg text-on-surface rounded-xl text-sm font-medium transition-all duration-300 hover:bg-white/40 dark:hover:bg-black/40 hover:scale-105 active:scale-95 shadow-md hover:shadow-lg border border-white/30 dark:border-white/20"
                >
            ...
            {isLoading && (
              <div className="flex items-center justify-center py-12 p-4 bg-white/30 dark:bg-black/30 backdrop-blur-lg rounded-2xl border border-white/30 dark:border-white/20 shadow-sm transition-all duration-300 hover:scale-[1.08]">
            ...
            {error && (
              <div className="p-4 bg-error-container/30 backdrop-blur-lg text-on-error-container rounded-2xl border border-error/30 shadow-sm transition-all duration-300 hover:scale-[1.08]">
            ...
            {videoDetails && (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-white/30 dark:bg-black/30 backdrop-blur-lg rounded-2xl p-4 text-center border border-white/30 dark:border-white/20 shadow-sm transition-all duration-300 hover:scale-[1.08] hover:shadow-lg">
                ...
                <div className="bg-white/30 dark:bg-black/30 backdrop-blur-lg rounded-2xl p-6 border border-white/30 dark:border-white/20 shadow-sm transition-all duration-300 hover:scale-[1.02]">
