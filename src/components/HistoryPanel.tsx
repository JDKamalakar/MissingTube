        ...
        <div className="flex items-center justify-between p-6 border-b border-outline-variant">
          <div className="flex items-center gap-3">
            <div className="p-3 bg-secondary-container rounded-2xl">
              <History className="w-6 h-6 text-on-secondary-container" />
            </div>
              ...
              <div className="grid gap-4">
                {playlists.map((playlist) => (
                  <div
                    ...
                    className="group bg-surface-container rounded-2xl p-4 hover:bg-surface-container-high transition-all duration-225 cursor-pointer border border-outline-variant hover:shadow-md hover:scale-[1.01] active:scale-[0.99]"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-225">
                        <button
                          ...
                          className="p-2 text-on-surface-variant hover:text-primary hover:bg-primary-container rounded-full transition-all duration-225 hover:scale-110 active:scale-95"
                        ...
                        <button
                          ...
                          className="p-2 text-on-surface-variant hover:text-error hover:bg-error-container rounded-full transition-all duration-225 hover:scale-110 active:scale-95"
