                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className="flex flex-shrink-0 items-center gap-1 sm:gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-225">
                        <button
                          ...
                          className="p-1.5 sm:p-2 text-on-surface-variant hover:text-primary hover:bg-primary-container rounded-xl transition-all duration-300 hover:scale-125 active:scale-95 group/delete"
