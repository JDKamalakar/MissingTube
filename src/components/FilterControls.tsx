  ...
  return (
    <>
      <div ref={dropdownRef} className={`relative flex-1 sm:w-auto ${isMobileMenuOpen ? 'z-20' : 'z-auto'}`}>
        ...
        <div className="hidden sm:relative sm:flex items-center bg-white/30 dark:bg-black/40 backdrop-blur-heavy rounded-2xl p-1 shadow-xl border border-white/30 dark:border-white/20 animate-slide-in-left sm:w-[540px] group">
          <div 
          ...
          {filterOptions.map(option => (
            ...
            >
              <option.icon className={`w-4 h-4 transition-all duration-225 ${
                filterMode === option.mode ? 'scale-110' : 'group-hover:rotate-12'
              }`} />
