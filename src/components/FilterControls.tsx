...
  ];
  
  // A map to correctly assign refs in the desktop view
  const desktopRefs = {
    all: allButtonRef,
    available: availableButtonRef,
    unavailable: unavailableButtonRef,
  };
...
              <button
                key={option.mode}
                // [FIXED] Correctly assigning the ref from our map
                ref={desktopRefs[option.mode]}
