    ...
    <>
      ...
      >
        {sortedVideos.map((video) => (
          <div
            key={video.id}
            className="bg-white/30 dark:bg-black/40 backdrop-blur-heavy rounded-3xl overflow-hidden shadow-xl border border-white/30 dark:border-white/20 hover:shadow-2xl transition-all duration-300 group elevation-2 hover:elevation-4 flex flex-col" // This 'group' is for the entire card
          >
            ...
            <div className="p-3 sm:p-4 pt-2 flex-1 flex flex-col mobile-gap">
              ...
              {/* Action buttons - MODIFIED: Group class moved to individual button */}
              <div className="flex gap-2 mt-auto">
                <button
                  onClick={(e) => handleSearchActions(video, e)}
                  // MODIFIED: 'group' class added here. Background is semi-transparent, icon has color
                ...
                >
                  {/* MODIFIED: Icon color and animation */}
                ...
                <button
                  onClick={(e) => handleShowDescription(video, e)}
                  // MODIFIED: 'group' class added here. Background is semi-transparent, icon has color
                  className="hidden sm:flex p-2 sm:p-3 bg-tertiary-container/20 backdrop-blur-lg rounded-2xl hover:bg-tertiary/90 transition-all duration-225 hover:scale-110 active:scale-95 shadow-sm hover:shadow-md touch-target group"
                >
                  {/* MODIFIED: Icon color and animation */}
