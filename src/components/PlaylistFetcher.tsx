      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div className="relative">
          <input
            ...
            // MODIFIED: Consistent height and padding for visual match
            className="w-full px-4 sm:px-6 py-3 h-16 rounded-2xl border border-outline-variant bg-white/20 dark:bg-gray-800/20 backdrop-blur-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-225 text-on-surface placeholder:text-on-surface-variant mobile-text-base touch-target"
            disabled={isLoading}
          />
        </div>
