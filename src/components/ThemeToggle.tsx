  ...
  return (
    <div
      ...
      className={`fixed z-50 transition-all duration-300 ease-in-out ${
        isScrolled
          ? 'top-4 right-16 sm:top-4 sm:right-4' // Mobile: next to nav, Desktop: top right
          : 'top-6 right-16 sm:top-7 sm:right-20' // Mobile: next to nav, Desktop: avoid hamburger
      }`}
      style={{
    ...
    >
      ...
      >
        <div className={`relative flex items-center justify-center transition-all duration-300 ease-in-out
                          ${isScrolled ? 'w-6 h-6 sm:w-10 sm:h-10' : 'w-6 h-6'} 
          ...
          <Monitor
            ...
            size={isScrolled ? (window.innerWidth >= 640 ? 36 : 24) : 24}
          />
