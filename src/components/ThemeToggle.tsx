...
        onClick={() => setShowOptions(!showOptions)}
        // ✨ --- CHANGES START HERE --- ✨
        className={`flex items-center justify-center bg-white/25 dark:bg-gray-800/25 backdrop-blur-md border border-gray-300/40 dark:border-gray-700/40 hover:bg-white/30 dark:hover:bg-gray-800/30 transition-all duration-300 group shadow-xl dark:shadow-lg dark:shadow-blue-500/30 dark:hover:shadow-blue-400/40 touch-target active:scale-95 hover:scale-110 ${
        // ✨ --- CHANGES END HERE --- ✨
          isScrolled
