...
                {/* Duration badge */}
                <div className="flex items-center absolute bottom-2 right-2 gap-1 bg-white/20 dark:bg-black/40 text-white backdrop-blur-xl rounded-2xl shadow-xl border border-white/30 elevation-2 px-3 py-3 text-sm opacity-100">
...
                  className="flex-1 flex items-center justify-center gap-2 py-3 px-3 bg-secondary/60 text-white rounded-2xl text-xs font-medium hover:bg-secondary/90 transition-all duration-225 hover:scale-105 active:scale-95 shadow-sm hover:shadow-md group"
                >
...
                <button
                  onClick={() => handleVideoClick(video.videoId)}
                  className="flex items-center justify-center p-3 bg-primary/40 text-white rounded-2xl hover:bg-primary/90 transition-all duration-225 hover:scale-110 active:scale-95 shadow-sm hover:shadow-md"
                >
