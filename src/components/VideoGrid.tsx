          ...
          >
            ...
            <div className="relative p-4 pb-2">
              <div className="relative bg-white/20 dark:bg-black/20 rounded-2xl overflow-hidden">
                ...
                {/* Unavailable badge */}
                {video.unavailable && (
                  <div className="absolute top-2 left-6 bg-error text-white text-xs px-3 py-3 rounded-2xl flex items-center gap-1 animate-pulse backdrop-blur-medium border border-white/20">
