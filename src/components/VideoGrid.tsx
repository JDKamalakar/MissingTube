...
                {/* Duration badge */}
                <div className="flex items-center absolute bottom-2 right-2 gap-1 bg-white/40 text-white backdrop-blur-xl rounded-2xl shadow-xl border border-white/30 elevation-2 px-3 py-3 text-sm">
                  <Clock className="w-3 h-3" />
                  {video.duration}
                </div>

                {/* Index number */}
                <div className="absolute top-2 left-2 flex items-center gap-1 bg-white/40 text-white backdrop-blur-xl rounded-2xl shadow-xl border border-white/30 elevation-2 px-3 py-3 text-xs">
                  #{video.index}
                </div>
              </div>
            </div>
