...
interface VideoGridProps {
  ...
  export const VideoGrid: React.FC<VideoGridProps> = ({ videos, filterMode = 'all' }) => {
    ...
    return (
      <>
        {/* Sort Controls */}
        <div className="flex gap-0.5 flex-col sm:flex-row items-center gap-4 mb-6 p-4 bg-white/30 dark:bg-black/40 backdrop-blur-heavy rounded-3xl border border-white/30 dark:border-white/20 elevation-2 hover:scale-105 active:scale-95 duration-300">
