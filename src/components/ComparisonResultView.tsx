                  ...
                  <div className="bg-white/20 dark:bg-gray-800/20 p-4 backdrop-blur-lg rounded-2xl flex flex-col gap-0.5 border border-gray-300/30 dark:border-gray-700/30 overflow-hidden">
                    {comparisonResult.unavailableMatches.map((match, index) => {
                      ...
                      return (
                        <div 
                          key={index} 
                          className={`group bg-white/30 dark:bg-gray-800/30 backdrop-blur-sm p-3 rounded-sm transition-all duration-300 transform origin-center hover:scale-[1.02] hover:rounded-xl hover:-translate-y-1 z-0 hover:z-10 ${cornerClass}`}
                        >
