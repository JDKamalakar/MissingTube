                ...
                <div className="bg-white/20 dark:bg-gray-800/20 backdrop-blur-lg p-4 rounded-2xl flex flex-col gap-0.5 border border-gray-300/30 dark:border-gray-700/30 overflow-hidden">
                  {comparisonResult.allVideos.map((video, index) => {
                    ...
                    return (
                      <div 
                        key={index}
                        className={`group bg-white/30 dark:bg-gray-800/30 rounded-sm backdrop-blur-sm p-3 transition-all duration-300 transform origin-center hover:scale-104 hover:-translate-y-1 z-0 hover:z-10 ${cornerClass}`}
                      >
