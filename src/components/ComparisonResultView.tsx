        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
          ...
          <div className="relative group w-full sm:w-auto">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-white/20 dark:bg-gray-800/20 backdrop-blur-md text-on-surface rounded-2xl font-medium shadow-md hover:shadow-lg hover:bg-white/30 hover:dark:bg-gray-700/30 transition-all duration-300 hover:scale-[1.04] active:scale-[0.97] border border-gray-300/30 dark:border-gray-700/30"
            >
