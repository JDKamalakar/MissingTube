              ...
              {sortedVideos.map((video, index) => (
                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center justify-center w-8 h-8 bg-primary text-white rounded-2xl text-sm font-medium border border-white/20 shadow-sm">
                      {video.index}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`text-sm px-3 py-1.5 rounded-2xl flex items-center gap-2 w-fit bg-white/20 dark:bg-black/20 text-gray-900 dark:text-white border border-white/20`}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-2 text-secondary hover:bg-secondary/20 rounded-2xl transition-all duration-225 hover:scale-110 active:scale-95"
                      ...
                      <button
                        onClick={(e) => handleShowDescription(video, e)}
                        className="p-2 text-tertiary hover:bg-tertiary/20 rounded-2xl transition-all duration-225 hover:scale-110 active:scale-95"
