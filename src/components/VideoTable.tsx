...
              <tr>
                <th
                  className={`px-6 py-4 text-left text-sm font-medium text-gray-900 dark:text-white uppercase tracking-wider cursor-pointer hover:bg-primary/40 dark:hover:bg-white/60 transition-all duration-225 select-none relative ${
